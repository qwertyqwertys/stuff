...
{/* --- THE STICKY CATEGORY BAR --- */}
      <div className={`sticky top-16 z-40 w-full backdrop-blur-md transition-all border-b ${
        ...
        <div className="max-w-7xl mx-auto px-4 relative flex items-center group">
          ...
          {/* Left Arrow */}
          {canScrollLeft && (
            <div className={`absolute left-0 z-50 flex items-center pr-12 h-full bg-gradient-to-r ${isLightMode ? 'from-white via-white/80' : 'from-[#0a0a0a] via-[#0a0a0a]/80'} to-transparent pointer-events-none`}>
              <button 
          ...
          >
            {categoriesWithCounts.map(cat => (
              ...
              >
                {cat.name} <span className="opacity-50 ml-1.5">{cat.count}</span>
              </button>
            ))}
          </div>
          ...
          {/* Right Arrow */}
          {canScrollRight && (
            <div className={`absolute right-0 z-50 flex items-center pl-12 h-full bg-gradient-to-l ${isLightMode ? 'from-white via-white/80' : 'from-[#0a0a0a] via-[#0a0a0a]/80'} to-transparent pointer-events-none`}>
              <button 
